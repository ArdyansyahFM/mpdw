...
author: "Fahmi Maulana Ardyansyah"
date: "2025-09-17"
...
```{r}
#input data
data <- read.csv("E:/(1) Projects/Semester 5/Metode Peramalan Deret Waktu/MPDW/Pertemuan-3/NewDelhi_Air_quality.csv")
str(data)
data
```

```{r}
# Pengubahan nama variabel agar mudah untuk diolah
names(data)[names(data) == "AQI"] <- "Yt"
names(data)[names(data) == "pm10"]  <- "Xt"
...
```{r, eval=FALSE, error=FALSE}
# ardlDlm(formula = NULL , data = NULL , x = data$NULL , y = data$NULL , p = 1 , q = 1 , remove = NULL )
```
